...
public:
    ...
    void setupUi(QWidget *Client)
    {
        ...
        gridLayout->addWidget(sIP, 0, 1, 1, 1);
        ...
        gridLayout->addWidget(sPort, 1, 1, 1, 1);
        ...
        horizontalSpacer = new QSpacerItem(292, 48, QSizePolicy::Expanding, QSizePolicy::Minimum);
